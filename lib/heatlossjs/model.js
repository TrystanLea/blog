...
heatloss.calculate = function() {
    ...
    for (var roomName in rooms) {
        ...
        out += "<td>Air changes per hour:</td><td><input class='room-input' room='"+roomName+"' prop=air_change_an_hour type='text' value='"+room.air_change_an_hour.toFixed(2)+"'/></td></tr>";
        out += "</table>";

...
heatloss.calculate = function() {
    ...
    for (var z in rooms) {
        ...
        var infiltration_kwh = infiltration_wk * degreedays * 0.024
        ...
        for (var i in room.radiators) {
           ...
           if (radiators[r.name].model=="pow") {
               ...
               r.heat = radiators[r.name].m * MWT + radiators[r.name].c
           }
    ...
    for (var roomName in rooms) {
        ...
        for (var i in room.radiators) {
            ...
            for (var z in radiators) {
                ...
                out += "<option "+selected+" value='"+z+"'>"+z+heat50k+"</option>";
            }
            out += "</select></td>"
